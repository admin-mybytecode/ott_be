...
<body style="background-color:#999999; padding:0px; margin:0px;">	
	...
	<ul id="trailer">
      ...
      if ($mid==$movie_id) {
		...
		]" data-downloadable="no" data-thumbnails-preview="<?php echo e(url('content/thumbnails.vtt')); ?>"> 
		...
		<ul data-ads="">
			...
			<div>
				<p class="classicDarkThumbnailTitle">Title: </span><?php echo e($movie->title); ?></p>
				<p class="minimalDarkThumbnailDesc">Description: </span><?php echo e($movie->detail); ?></p>
			</div>
