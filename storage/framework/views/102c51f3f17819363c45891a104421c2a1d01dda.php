...
<head>
  ...
  rel="stylesheet"/>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/button.datatable.css')); ?>">
   <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/datatable.min.css')); ?>"/>
   <link href ="<?php echo e(asset('css/datatable_material.css')); ?>" rel="stylesheet" />
 
  <link href ="<?php echo e(asset('css/dataTables.material.min.css')); ?>" rel="stylesheet" />
 
   <link href="//cdn.datatables.net/responsive/2.2.3/css/responsive.dataTables.min.css" rel="stylesheet">
  
  
<link rel="stylesheet" href="<?php echo e(asset('css/maincss.css')); ?>"/>
  ...
  <aside class="main-sidebar" style="background-image: url(<?php echo e(asset('images/sidebar-7.jpg')); ?>);">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a class="<?php echo e(Nav::isResource('plan')); ?>" href="<?php echo e(url('/admin/plan')); ?>" title="Active Plan"><i class="material-icons">description</i> <span>Users Subscription</span></a>
        </li>
        <?php endif; ?>
       
       <li><a class="" href="<?php echo e(url('/admin/temple')); ?>" title="Movies"><i class="material-icons">home</i> <span>Temple</span></a></li>
       
        <li><a class="<?php echo e(Nav::isResource('movies')); ?>" href="<?php echo e(url('/admin/movies')); ?>" title="Movies"><i class="material-icons">ondemand_video</i> <span>Videos</span></a></li>
        <li><a class="<?php echo e(Nav::isResource('livetv')); ?>" href="<?php echo e(url('/admin/livetv')); ?>" title="Live TV"><i class="material-icons">shop_two</i> <span>Live TV</span></a></li>
      ...
      <li class="treeview">
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isRoute('player.set')); ?> <?php echo e(Nav::isRoute('ads')); ?>" title="Site Settings">
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isRoute('front.slider.limit')); ?> <?php echo e(Nav::isResource('customize')); ?>" title="Site Customization">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Nav::isRoute('front.slider.limit')); ?>"><a href="<?php echo e(route('front.slider.limit')); ?>" title="Login"><i class="fa fa-circle-o"></i> Front Page Slider Limit</a></li>
          </ul>
        </li>
        
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isResource('settings')); ?> <?php echo e(Nav::isRoute('term_con')); ?> <?php echo e(Nav::isRoute('pri_pol')); ?> <?php echo e(Nav::isRoute('refund_pol')); ?><?php echo e(Nav::isRoute('adsense')); ?><?php echo e(Nav::isRoute('sociallogin')); ?> <?php echo e(Nav::isRoute('copyright')); ?> <?php echo e(Nav::isRoute('mail.getset')); ?>" title="Site Settings">
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isRoute('pricing.text')); ?> <?php echo e(Nav::isResource('translation')); ?>">
          ...
          <ul class="treeview-menu">
            <li><a class="<?php echo e(Nav::isResource('languages')); ?>" href="<?php echo e(url('/admin/languages')); ?>" title="Languages"><i class="fa fa-circle-o"></i>language <span>Languages</span></a></li>
    ...
    <li class="<?php echo e(Nav::isRoute('pricing.get')); ?>"><a href="<?php echo e(route('pricing.get',$package->id)); ?>" title="Custom Pricing text"><i class="fa fa-circle-o"></i>Pricing Text</a></li>
        ...
        <li><a class="<?php echo e(Nav::isRoute('view.track')); ?>" href="<?php echo e(route('view.track')); ?>" title="View Tracker"><i class="material-icons">visibility</i> <span>View Tracker</span></a></li>
       <?php endif; ?>
...
<script src="<?php echo e(asset('js/datatable.js')); ?>" type="text/javascript"></script>
