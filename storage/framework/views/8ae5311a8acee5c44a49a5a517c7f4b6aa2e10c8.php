                ...
                <div id="prime-description-block<?php echo e($movie->id); ?>" class="prime-description-block">
                  <div class="prime-description-under-block">
                    ...
                    <div class="des-btn-block">
                      ...
                      <?php else: ?>
                         <?php if($movie->trailer_url != null || $movie->trailer_url != ''): ?>
                       <a href="<?php echo e(route('guestwatchtrailer',$movie->id)); ?>" class="iframe btn btn-default"><?php echo e($popover_translations->where('key', 'watch trailer')->first->value['value']); ?></a>
