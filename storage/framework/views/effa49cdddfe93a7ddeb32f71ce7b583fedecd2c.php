...
<?php $__env->startSection('title',"View All"); ?>
  ...
  <?php if(isset($movies) && count($movies) > 0 ): ?>
          <div class="genre-prime-block">
            ...
            <div class="container-fluid">
              <h5 class="section-heading"><?php echo e($home_translations->where('key', 'view all')->first->value['value']); ?></h5>
              <div class="">
                <?php if(isset($movies)): ?>
                      ...
                      <div id="prime-next-item-description-block<?php echo e($item->id); ?>" class="prime-description-block">
                        <div class="prime-description-under-block">
                          ...
                          <div class="main-des">
                            ...
                            <?php else: ?>
                              <a href="<?php echo e(url('movie/guest/detail',$item->id)); ?>">Read more</a>
                            <?php endif; ?>
                          </div>
