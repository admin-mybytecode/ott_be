...
<?php $__env->startSection('title','Create Audio Language'); ?>
        ...
        <div class="admin-form-block z-depth-1">
          <?php echo Form::open(['method' => 'POST', 'action' => 'AudioLanguageController@store']); ?>
            ...
            <div class="form-group<?php echo e($errors->has('language') ? ' has-error' : ''); ?>">
              ...
              <?php echo Form::text('language', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Please enter audio and subtitle language']); ?>
