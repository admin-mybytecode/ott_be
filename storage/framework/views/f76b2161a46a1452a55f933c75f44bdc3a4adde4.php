          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <div id="wishlistelement" class="screen-play-btn-block">
                ...
                <?php else: ?>
                  <?php if($movie->trailer_url != null || $movie->trailer_url != ''): ?>
                    <a href="<?php echo e(route('guestwatchtrailer',$movie->id)); ?>" class="iframe btn-default"><?php echo e($popover_translations->where('key', 'watch trailer')->first->value['value']); ?></a>
                  <?php endif; ?>
                <?php endif; ?>
              </div>
            </div>
              ...
              <div class="movie-series-block">
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    <?php if($subscribed==1): ?>
                  <div class="col-sm-7 pad-0">
                    <?php if($episode->seasons->tvseries->age_req == 'all age' || $age>=str_replace('+', '', $episode->seasons->tvseries->age_req)): ?>
                  ...
                  <?php endif; ?>
                    <ul class="movie-series-des-list">
                      ...
                      <li><?php echo e($episode->seasons->tvseries->age_req); ?></li>
                      <li>
                  ...
                  <?php if($item->type == "S"): ?>
                    ...
                    <div class="genre-prime-slide">
                      <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-title="#prime-mix-description-block<?php echo e($item->id); ?><?php echo e($item->type); ?>">
                        ...
                        <?php else: ?>
                          <a href="<?php echo e(url('show/guest/detail',$item->id)); ?>">
                          <?php if($item->thumbnail != null): ?>
                            <img src="<?php echo e(asset('images/tvseries/thumbnails/'.$item->thumbnail)); ?>" class="img-responsive" alt="genre-image">
                          <?php elseif($item->tvseries->thumbnail != null): ?>
                            <img src="<?php echo e(asset('images/tvseries/thumbnails/'.$item->tvseries->thumbnail)); ?>" class="img-responsive" alt="genre-image">
                      ...
                      <?php if($item->type == 'S'): ?>
                        <div class="genre-slide">
                          ...
                          <div class="genre-slide-dtl">
                            ...
                            <?php else: ?>
                            <h5 class="genre-dtl-heading"><a href="<?php echo e(url('show/guest/detail/'.$item->id)); ?>"><?php echo e($item->tvseries->title); ?></a></h5>
                            <?php endif; ?>
                      ...
                      <?php elseif($item->type == 'M'): ?>
                        <div class="genre-slide">
                          ...
                          <div class="genre-slide-dtl">
                            ...
                            <?php else: ?> 
                            <h5 class="genre-dtl-heading"><a href="<?php echo e(url('movie/guest/detail/'.$item->id)); ?>"><?php echo e($item->title); ?></a></h5>
                            <?php endif; ?>
                          </div>
                        </div>
                      <?php endif; ?>
