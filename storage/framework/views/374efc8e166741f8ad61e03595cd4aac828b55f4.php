							...
							<form action="<?php echo e(route('front.slider.update',$update5->id)); ?>" method="POST">
								...
								<div class="row">
										...
										<div class="col-md-12">
												<div class="form-group">
														<label>Total Items To Show :</label>
														<input type="number" max="<?php echo e($movie_max); ?>" min="1" value="<?php echo e($update5->item_show); ?>" name="item_show">
												</div>
										</div>
							...
							<form action="<?php echo e(route('front.slider.update',$update6->id)); ?>" method="POST">
								...
								<div class="row">
										...
										<div class="col-md-12">
												<div class="form-group">
														<label>Total Items To Show :</label>
														<input type="number" max="<?php echo e($season_max); ?>" min="1" value="<?php echo e($update6->item_show); ?>" name="item_show">
												</div>
										</div>
							...
							<form action="<?php echo e(route('front.slider.update',$update7->id)); ?>" method="POST">
								...
								<div class="row">
										...
										<div class="col-md-12">
												<div class="form-group">
														<label>Total Items To Show :</label>
														<input type="number" max="<?php echo e($movie_max); ?>" min="1" value="<?php echo e($update7->item_show); ?>" name="item_show">
												</div>
										</div>
							...
							<form action="<?php echo e(route('front.slider.update',$update8->id)); ?>" method="POST">
								...
								<div class="row">
										...
										<div class="col-md-12">
												<div class="form-group">
														<label>Total Items To Show :</label>
														<input type="number" max="<?php echo e($season_max); ?>" min="1" value="<?php echo e($update8->item_show); ?>" name="item_show">
												</div>
										</div>
							...
							<form action="<?php echo e(route('front.slider.update',$update9->id)); ?>" method="POST">
								...
								<div class="row">
										...
										<div class="col-md-12">
												<div class="form-group">
														<label>Total Items To Show :</label>
														<input type="number" max="<?php echo e($movie_max); ?>" min="1" value="<?php echo e($update9->item_show); ?>" name="item_show">
												</div>
										</div>
							...
							<form action="<?php echo e(route('front.slider.update',$update10->id)); ?>" method="POST">
								...
								<div class="row">
										...
										<div class="col-md-12">
												<div class="form-group">
														<label>Total Items To Show :</label>
														<input type="number" max="<?php echo e($season_max); ?>" min="1" value="<?php echo e($update9->item_show); ?>" name="item_show">
												</div>
										</div>
