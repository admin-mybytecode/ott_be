                        ...
                        <div id="prime-mix-description-block<?php echo e($item->id); ?>" class="prime-description-block">
                          ...
                          <?php if($withlogin==0 && $auth): ?>
                            <?php if($item->trailer_url != null || $item->trailer_url != ''): ?>
                               <a class="iframe btn btn-default" href="<?php echo e(route('watchTrailer',$item->id)); ?>"><?php echo e($popover_translations->where('key', 'watch trailer')->first->value['value']); ?></a>
                            <?php endif; ?>
                            <?php else: ?>
                             <?php if($item->trailer_url != null || $item->trailer_url != ''): ?>
                               <a class="iframe btn btn-default" href="<?php echo e(route('guestwatchtrailer',$item->id)); ?>"><?php echo e($popover_translations->where('key', 'watch trailer')->first->value['value']); ?></a>
                            <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="genre-prime-slide">
                      ...
                      <?php if($subscribed==1 && $auth): ?>
                          <?php if($movie->trailer_url != null || $movie->trailer_url != ''): ?>
                             <a class="iframe btn btn-default" href="<?php echo e(route('watchTrailer',$movie->id)); ?>"><?php echo e($popover_translations->where('key', 'watch trailer')->first->value['value']); ?></a>
                          <?php endif; ?>
                          <?php else: ?>
                           <?php if($movie->trailer_url != null || $movie->trailer_url != ''): ?>
                             <a class="iframe btn btn-default" href="<?php echo e(route('guestwatchtrailer',$movie->id)); ?>"><?php echo e($popover_translations->where('key', 'watch trailer')->first->value['value']); ?></a>
                          <?php endif; ?>
                          <?php endif; ?>
                      ...
                      ?>
                        ...
                        <?php endif; ?>
                          ...
                          <div id="prime-next-show-description-block<?php echo e($series->id); ?><?php echo e($series->type); ?>" class="prime-description-block">
                            ...
                            <div class="des-btn-block">
                              <?php if(isset($gets1->episodes[0])): ?>
                                <?php if($series->age_req == 'all age' || $age>=str_replace('+', '', $series->age_req)): ?>
                              <?php if($gets1->episodes[0]->video_link['iframeurl'] !=""): ?>
   ...
   <div class="col-lg-2 col-md-3 col-xs-6 col-sm-4">
        ...
        <!-- genre block  for movies-->
         ...
         <div class="genre-prime-block">
              ...
              <?php break; ?>
                 <?php elseif($s->id==4  && $s->sliderview==0): ?>
 <div class="genre-prime-block">
