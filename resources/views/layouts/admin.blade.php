  ...
  <aside class="main-sidebar" style="background-image: url({{asset('images/sidebar-7.jpg')}});">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a class="" href="{{url('/admin/temple')}}" title="Movies"><i class="material-icons">home</i> <span>Temple</span></a></li>
       
        <li><a class="{{ Nav::isResource('movies') }}" href="{{url('/admin/movies')}}" title="Movies"><i class="material-icons">ondemand_video</i> <span>Videos</span></a></li>
